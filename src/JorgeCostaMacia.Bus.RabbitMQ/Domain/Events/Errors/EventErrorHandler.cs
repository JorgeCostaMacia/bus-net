...
/// subscriber fails to decide the delivery's outcome (republish to retry or park to its error
/// queue). Framework-internal: a service tunes the lane through its subscriber registration
