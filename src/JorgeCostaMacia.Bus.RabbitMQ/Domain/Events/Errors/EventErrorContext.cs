...
/// <summary>
/// The event context an error handler receives when a delivery fails terminally — the delivery's
/// <see cref="EventContext{TEvent}"/> itself extended with the <see cref="IErrorContext{TError}"/>
