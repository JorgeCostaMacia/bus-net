...
/// </summary>
public interface IAggregateFilteredMessageContext : IMessageContext
{
...
/// <summary>The filtered envelope facet bound to a specific inbound message type.</summary>
/// <typeparam name="TMessage">The type of the delivered message.</typeparam>
public interface IAggregateFilteredMessageContext<TMessage> : IAggregateFilteredMessageContext, IMessageContext<TMessage>
