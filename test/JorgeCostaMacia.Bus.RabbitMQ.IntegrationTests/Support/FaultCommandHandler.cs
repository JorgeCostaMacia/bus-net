...
/// test delivers a body that fails to deserialize, so the delivery breaks while building the context —
/// before any handler runs — and takes the fault lane to <c>{queue}.fault</c>.
/// </summary>
