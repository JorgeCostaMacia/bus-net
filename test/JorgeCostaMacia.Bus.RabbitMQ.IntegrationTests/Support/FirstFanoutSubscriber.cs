...
/// <summary>
/// The first subscriber to <see cref="FanoutEvent"/> on its own queue: signals the payload it received
/// on the shared <see cref="FanoutProbe"/>, so the test can prove its queue got a copy of the broadcast.
/// </summary>
