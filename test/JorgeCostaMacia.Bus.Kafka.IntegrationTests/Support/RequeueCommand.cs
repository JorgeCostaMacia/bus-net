...
/// on the redelivery re-produced by a <c>00:00</c> retry step — exercising the immediate-requeue path
/// (a produce back to the topic tail at a new offset, distinct from the Quartz scheduled retry).
/// </summary>
