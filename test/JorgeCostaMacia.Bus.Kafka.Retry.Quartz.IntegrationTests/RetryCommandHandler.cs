...
/// on the second — the redelivery the Quartz job produces back to the topic when the trigger fires,
/// which the consumer group re-reads. It records both invocations on the shared <see cref="RetryProbe"/>
/// the test awaits.
/// </summary>
